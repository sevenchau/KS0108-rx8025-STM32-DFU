...
#define  BSP_INT_ID_CAN1_TX                               19    /* USB High Priority or CAN TX Interrupts               */
#define  BSP_INT_ID_CAN1_RX0                              20    /* USB Low Priority or CAN RX0 Interrupts               */
#define  BSP_INT_ID_CAN1_RX1                              21    /* CAN RX1 Interrupt                                    */
#define  BSP_INT_ID_CAN1_SCE                              22    /* CAN SCE Interrupt                                    */
...
#define  BSP_INT_ID_DMA2_CH4                              59    /* DMA2 Channel 4 and DMA2 Channel 5 global Interrupt   */
#define  BSP_INT_ID_DMA2_CH5                              60    /* DMA2 Channel 4 and DMA2 Channel 5 global Interrupt   */
#define  BSP_INT_ID_ETH                                   61    // Ethernet
#define  BSP_INT_ID_ETH_WKUP                              62    // Ethernet Wakeup through EXTI line
#define  BSP_INT_ID_CAN2_TX                               63    // CAN2 TX
#define  BSP_INT_ID_CAN2_RX0                              64    // CAN2 RX0
#define  BSP_INT_ID_CAN2_RX1                              65    // CAN2 RX1
#define  BSP_INT_ID_CAN2_SCE                              66    // CAN2 SCE
#define  BSP_INT_ID_OTG_FS                                67    // USB OTG FS
